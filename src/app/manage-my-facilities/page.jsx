...
import { FiClock, FiDollarSign, FiLayers, FiMapPin, FiUsers, FiEdit3 } from 'react-icons/fi';
            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
               ...
               <div className="mb-8 pb-5 pt-5 border-b border-slate-200/60">
                 ...
                 <p className="mt-2 text-sm font-medium text-slate-500">
                   Manage your listed facilities, track operational status, and view details.
                 </p>
               </div>
                         ...
                         >
                           ...
                           <div className="flex-1 space-y-4">
                             ...
                             <div className="grid grid-cols-2 gap-4 border-t border-slate-50 pt-3 sm:grid-cols-3">
                               <div>
                                 <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Price Rate</p>
                                 <p className="mt-0.5 text-lg font-black text-emerald-600 flex items-center">
                                   <FiDollarSign className="text-base -mr-0.5" />
                                   {facility.pricePerHour}
                                   <span className="text-xs font-bold text-slate-400/80 ml-0.5">/hr</span>
                                 </p>
                               </div>
                               ...
                               <div>
                                 ...
                                 <div className="mt-1 flex items-center gap-1 text-sm font-bold text-slate-700">
                                   ...
                                   {facility.capacity} <span className="font-medium text-slate-400">Max</span>
                                 </div>
                               </div>
       
                               <div className="col-span-2 sm:col-span-1">
                                 <p className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">Available Slots</p>
                                 <div className="flex flex-col gap-1">
                                   {facility.availableTimeSlots?.slice(0, 2).map((slot, idx) => (
                                     <div key={idx} className="flex items-center gap-1 text-xs font-semibold text-slate-600 bg-slate-50 px-2 py-0.5 rounded-md border border-slate-100 w-fit">
