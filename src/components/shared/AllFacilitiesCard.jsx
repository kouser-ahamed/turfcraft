    ...
    <Card className="group overflow-hidden rounded-[1.75rem] border border-white/70 bg-white/90 shadow-[0_20px_70px_rgba(15,23,42,0.08)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_90px_rgba(15,23,42,0.14)]">
      <div className="relative overflow-hidden rounded-xl">
        <Image
          ...
          width={500}
          height={300}
          className="h-56 w-full object-cover transition-transform duration-700 group-hover:scale-105 rounded-xl"
        />
      ...
      <div className="space-y-4 p-5">
        ...
        <div className="flex items-end justify-between gap-4 rounded-2xl border border-slate-100 bg-linear-to-br from-slate-50 via-white to-emerald-50/40 p-4">
          <div  className="flex justify-between items-end-safe gap-10">
            <div>
        ...
        <Link href={`/all-facilities/${_id}`}>
          <Button
            variant="outline"
            className="h-12 w-full rounded-full border-transparent bg-linear-to-r from-emerald-600 via-emerald-500 to-lime-500 font-semibold text-white shadow-lg shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-0.5 hover:from-emerald-500 hover:via-emerald-400 hover:to-lime-400 hover:text-white"
